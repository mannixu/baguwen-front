<template>
	<view>
		<view class="test-actions">
			<view class="iconfont icon-shangyibu" hover-class="bg-light" @click="pre"
				:class=" current <= 1 ? 'text-light-muted' : '' "></view>
			...
			<view hover-class="bg-light" class="iconfont icon-xiayibu" @click="next"
				:class=" current >= total ? 'text-light-muted' : '' "></view>
		</view>
