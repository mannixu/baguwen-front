<template>
  ...
  <view class="detail-container" >
    ...
    <block v-if="articleData">
      <!-- 标题 -->
      <view class="title">{{ articleData.blog.title }}</view>
      <view class="detail-info">
        <view class="detail-left">
          <view class="avatar-box" >
            <!-- 头像 -->
            <image class="avatar"  :src="articleData.blog.avatar"></image>
          </view>
          <view class="author-box">
            <!-- 作者 -->
            <text class="author">{{ articleData.blog.nickname }}</text>
            <!-- 发布时间 -->
            <text class="release-time">{{ articleData.blog.updateTime }}</text>
          </view>
        </view>
	  ...
	  <!-- 文章内容   scroll-table表格可以横行滑动-->
	        <mp-html class="markdown_views" :content="addClassFromHTML(articleData.blog.content)" scroll-table />
